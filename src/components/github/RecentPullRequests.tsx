...
export default function RecentPullRequests() {
  ...
  const { recentPullRequests, isLoading } = useRecentPullRequests(
      ...
      <ListLoader
        ...
        element={
          <CardHeader
            ...
            tooltip="View the latest pull requests sorted by either creation time, or update time."
  ...
  const getStatusText = (pull: IRecentPullRequests) => {
  ...
  return (
    <Layout>
      <CardHeader
        ...
        intervals={intervals}
      />
      <div className="max-h-[calc(6*6.3rem)] md:max-h-[calc(5*6.2rem)] overflow-y-auto scrollbar scrollbar-thumb-indigo-500 scrollbar-track-indigo-100 overflow-x-hidden">
